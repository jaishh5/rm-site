			...
			<Container style={{ paddingBottom: '50px', paddingTop: '50px' }}>
				<Row style={{ paddingTop: '30px' }}>
					<div data-aos="fade-right" className="col-12 col-md-4 project">
						...
						<h4 style={{ paddingTop: '20px' }}>BLOG 1</h4>
					</div>
					<div data-aos="fade-down" className="col-12 col-md-4 project">
						<div className="inner mx-auto">
							<img src="assets/images/sample.jfif" alt="Blog 2" />
						...
						<h4 style={{ paddingTop: '20px' }}>BLOG 2</h4>
					</div>
					<div data-aos="fade-left" className="col-12 col-md-4 project">
						<div className="inner mx-auto">
							<img src="assets/images/sample.jfif" alt="Blog 3" />
							<div className="overlay">
								<div className="workinfo">
						...
						<h4 style={{ paddingTop: '20px' }}>BLOG 3</h4>
					</div>
				</Row>
				<Row style={{ paddingTop: '50px' }}>
					<div data-aos="fade-right" className="col-12 col-md-4 project">
						<div className="inner mx-auto">
							<img src="assets/images/sample.jfif" alt="Blog 4" />
							<div className="overlay">
								<div className="workinfo">
						...
						<h4 style={{ paddingTop: '20px' }}>BLOG 4</h4>
					</div>				
				</Row>
